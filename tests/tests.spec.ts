...
test.describe('Authentication', () => {
    ...
    test('app redirects to sign in page when non-authenticated', async ({
        page,
        context
    }) => {
        await page.goto('/app');
    ...
    test('login with github and be redirected to app page', async ({
        page,
        context
    }) => {
        ...
        if (
            await page.locator("xpath=//input[@id='login_field']").isVisible()
        ) {
            await page
                .locator("xpath=//input[@id='login_field']")
                .fill(process.env.GH_TEST_LOGIN!);
            await page
                .locator("xpath=//input[@id='password']")
                .fill(process.env.GH_TEST_PASSWORD!);
            await page
