 ...
 */
export const makeAPIRequest = async (url: string, method: string, headers: any, data: any = null) => {
 ...
 * @returns The json response
 */
export const makeGraphQLRequest = async (url: string, headers: any, query: string, variables: any = null) => {
